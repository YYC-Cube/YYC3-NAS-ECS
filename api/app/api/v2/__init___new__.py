...
# 注册新增的API模块
bp.register_blueprint(monitoring_bp)
bp.register_blueprint(nas_bp)
bp.register_blueprint(frp_bp)
bp.register_blueprint(ddns_api_bp)
